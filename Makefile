...
sync-kconfig:
	@python3 tools/config_to_header.py .config examples/stm32_g431/cli_kconfig.h
	@python3 tools/config_to_header.py .config examples/stm32f103_keil/cli_kconfig.h
	@python3 tools/config_to_header.py .config examples/pc_linux/cli_kconfig.h
	@python3 tools/config_to_header.py .config examples/external_demo/cli_kconfig.h
	@echo "Synced cli_kconfig.h to all example projects from .config"
